                  ...
                  workOrderList != null
                    ...
                    workOrderList.length
                      ...
                      workOrderList.map(item => {
                        return (
                          <TouchableOpacity style={[styles.box, item.RemainMHRS != null && item.RemainMHRS < 2 ? styles.boxWarning : null]} key={item.WorkOrder} onPress={() => onChangeItem(item.WorkOrder, item.RemainMHRS)}>
