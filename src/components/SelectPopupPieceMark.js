...
const SelectPopupPieceMark = props => {
  return (
    <Modal
      animationType='fade'
      transparent={true}
                        ...
                        return (
                          <TouchableOpacity style={styles.box} key={item.HeatNo_TagNo} onPress={() => props.onChangeItem(item)}>
                            ...
                            <View style={styles.row}>
                              ...
                              <Text style={styles.cellData}>{Formater.formatEmptyData(item.PieceDescription)}</Text>
                            </View>
                            <View style={styles.row}>
                              <Text style={styles.cellTitle}>HeatNo:</Text>
                              <Text style={styles.cellData}>{Formater.formatEmptyData(item.HeatNo_TagNo)}</Text>
                            </View>
                          </TouchableOpacity>
                        );
                      })
...
export default SelectPopupPieceMark;