...
const SelectPopupVertical = ({ visible, leftHeader, rightHeader, data, leftKey, rightKey, onChangeItem, onCancel }) => {
                  ...
                  data != null
                    ...
                    data.length
                      ...
                      data.map((item, index) => {
                        ...
                        return (
                          <TouchableOpacity style={modals.col} key={index} onPress={() => { onChangeItem(item) }}>
                            <Text >
                              {valueLeft}
                            </Text>
                            <Text >
...
const modals = StyleSheet.create({
  ...
  list: {
    padding: 16,
    width: windowWidth * 0.85,
    maxHeight: (windowHeight * 0.85) - 32 - 76 - 40,
  },
  row: {
    flexDirection: 'row',
...
export default SelectPopupVertical;