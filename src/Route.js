...
import OpenManualDrawingScreen from './screens/general/opendrawing/OpenManualDrawingScreen';
...
import QualifyElectricalWorkersAddScreen from './screens/electircal/qualify_electrical_workers/QualifyElectricalWorkersAddScreen';
...
const ElectricalCONSStackScreens = () => {
  return (
    <ElectricalCONSStack.Navigator screenOptions={optionNavigation}>
      ...
      />
      <ElectricalCONSStack.Screen
        name={'QualifyElectricalWorkersAdd'}
...
const CommonStackScreens = () => {
  return (
    <CommonStack.Navigator screenOptions={optionNavigation}>
      ...
      />
      <CommonStack.Screen
        name='OpenManualDrawing'
        component={OpenManualDrawingScreen}
        options={({ route }) => ({
          title: route.params.title,
          headerBackTitle: 'Back',
        })}
