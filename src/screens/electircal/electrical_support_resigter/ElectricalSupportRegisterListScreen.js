...
import { GetElectricalSupportRegisterListAPI, UpdateElectricalSupportRegisterListAPI } from '../../../apis/eit/EITAPI';

import SelectPopup from '../../../components/SelectPopup';
import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';

const ElectricalSupportRegisterListScreen = ({ route, navigation }) => {
  ...
  const submitToServer = async () => {
    ...
    setIsUploading(true);
    UpdateElectricalSupportRegisterListAPI(listUpdate)
      .then(res => {
        if (res.success) {
          setEITUpdateItems([]);
          callAPI(getEITItems);
...
export default ElectricalSupportRegisterListScreen;