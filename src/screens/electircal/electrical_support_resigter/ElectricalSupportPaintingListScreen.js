...
import { GetElectricalSupportRegisterListAPI, UpdateElectricalSupportPaintingAPI } from '../../../apis/eit/EITAPI';

import SelectPopup from '../../../components/SelectPopup';
import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';

const ElectricalSupportPaintingListScreen = ({ route, navigation }) => {
  ...
  const submitToServer = async () => {
    ...
    setIsUploading(true);
    UpdateElectricalSupportPaintingAPI(listUpdate)
      .then(res => {
        if (res.Success) {
          setEITUpdateItems([]);
          callAPI(getEITItems);
...
export default ElectricalSupportPaintingListScreen;