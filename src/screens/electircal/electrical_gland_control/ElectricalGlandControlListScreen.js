...
import { GetElectricalGlandControlListAPI } from '../../../apis/eit/EITAPI';

import SelectPopup from '../../../components/SelectPopup';
import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';

const ElectricalGlandControlListScreen = ({ route, navigation }) => {
  ...
  async function getCableList() {
    ...
    GetElectricalGlandControlListAPI(projectCode, facility, cableName, subSystem)
      .then(res => {
...
export default ElectricalGlandControlListScreen;