...
import { GetInstrumentGlandControlListAPI } from '../../../apis/eit/EITAPI';

import SelectPopup from '../../../components/SelectPopup';
import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';

const InstrumentGlandControlListScreen = ({ route, navigation }) => {
  ...
  async function getCableList() {
    ...
    GetInstrumentGlandControlListAPI(projectCode, facility, cableName, subSystem)
      .then(res => {
  ...
  const renderItem = ({ _, item }) => {
    ...
    const isPulled = item.IsPulled;
    return (
      <TouchableOpacity
        style={isPulled ? styles.box : styles.disabledBox}
        ...
        <View style={styles.row}>
          ...
          <View style={styles.cellTwo}>
            <Text style={textStyle}>{Formater.formatDateData(item.DatePulling)}</Text>
          </View>
        </View>
      </TouchableOpacity>
    );
...
export default InstrumentGlandControlListScreen;