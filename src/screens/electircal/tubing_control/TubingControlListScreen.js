...
import { GetTubingControlListAPI, UpdateTubingControlListAPI } from '../../../apis/eit/EITAPI';

import SelectPopup from '../../../components/SelectPopup';
import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';

const TubingControlListScreen = ({ route, navigation }) => {
  ...
  const submitToServer = async () => {
    ...
    setIsUploading(true);
    UpdateTubingControlListAPI(listUpdate)
      .then(res => {
        if (res.success) {
          setEITUpdateItems([]);
  ...
  const renderItem = ({ _, item }) => {
    const status = !!item.InstallComplete ? 1 : 0;
    ...
    return (
      <View style={styles.box}>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.cellTwo}>
            <Text style={textStyle}>{Formater.formatEmptyData(item.DrawingNo)}</Text>
          </View>
        </View>
        <View style={styles.row}>
          <View style={styles.cellOne}>
          ...
          <View style={styles.cellTwo}>
            <Text style={textStyle}>{Formater.formatEmptyData(item.ServiceDescription)}</Text>
          </View>
        </View>
        <View style={styles.row}>
          <View style={styles.cellOne}>
          ...
          <View style={styles.cellTwo}>
            <Text style={textStyle}>{Formater.formatEmptyData(item.TubeName)}</Text>
          </View>
        </View>
        <View style={styles.row}>
          <View style={styles.cellOne}>
          ...
          <View style={styles.cellTwo}>
            <Text style={textStyle}>{Formater.formatEmptyData(item.From)}</Text>
          </View>
        </View>
        <View style={styles.row}>
          <View style={styles.cellOne}>
          ...
          <View style={styles.cellTwo}>
            <Text style={textStyle}>{Formater.formatEmptyData(item.To)}</Text>
          </View>
        </View>
        <View style={styles.row}>
          <View style={styles.cellOne}>
          ...
          <View style={styles.cellTwo}>
            <View style={styles.cellTwoRow}>
              <Text>Install:</Text>
              <CheckBox
                value={!!item.InstallComplete}
                onValueChange={newValue => _onChangeCheckbox(item.RowIndex, 'InstallComplete', newValue)}
          ...
          <View style={styles.container}>
            {
              isShowDescription.show
                ...
                (<View style={styles.headerContainer}>
                  ...
                  <View style={styles.rowInfoAction}>
                    <Text style={styles.infoTitleAction}>Service:</Text>
                    <View style={styles.inputContainer}>
                      <TextInput
                        style={styles.inputText}
                        value={service}
                        onChangeText={_onChangeService}
                        underlineColorAndroid='transparent'
                      />
                      {
                        service == ''
...
export default TubingControlListScreen;