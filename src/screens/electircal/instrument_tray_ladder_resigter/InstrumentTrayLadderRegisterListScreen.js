...
import { GetInstrumentTrayLadderRegisterListAPI, UpdateInstrumentTrayLadderRegisterListAPI } from '../../../apis/eit/EITAPI';

import SelectPopup from '../../../components/SelectPopup';
import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';

const InstrumentTrayLadderRegisterListScreen = ({ route, navigation }) => {
  ...
  async function getEITItems() {
    ...
    GetInstrumentTrayLadderRegisterListAPI(projectCode, facility, drawingNo, location, name)
      .then(res => {
  ...
  const submitToServer = async () => {
    ...
    setIsUploading(true);
    UpdateInstrumentTrayLadderRegisterListAPI(listUpdate)
      .then(res => {
        if (res.success) {
          setEITUpdateItems([]);
...
export default InstrumentTrayLadderRegisterListScreen;