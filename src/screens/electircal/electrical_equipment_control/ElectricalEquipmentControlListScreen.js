...
import { GetElectricalEquipmentControlListAPI, UpdateElectricalEquipmentControlListAPI } from '../../../apis/eit/EITAPI';

import SelectPopup from '../../../components/SelectPopup';
import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';

const ElectricalEquipmentControlListScreen = ({ route, navigation }) => {
  ...
  async function getEITItems() {
    ...
    GetElectricalEquipmentControlListAPI(projectCode, facility, drawingNo, location, name)
      .then(res => {
  ...
  const submitToServer = async () => {
    ...
    setIsUploading(true);
    UpdateElectricalEquipmentControlListAPI(listUpdate)
      .then(res => {
        if (res.success) {
          setEITUpdateItems([]);
...
export default ElectricalEquipmentControlListScreen;