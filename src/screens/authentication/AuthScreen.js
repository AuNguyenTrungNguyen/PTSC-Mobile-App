...
import { SafeAreaView, Alert, Platform, Linking, View, TouchableOpacity, Text, ActivityIndicator } from 'react-native';
    ...
    <SafeAreaView style={{ flex: 1 }} >
      {
        isLoading
          ...
          : isError
            ...
            :
            <View style={{ width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', backgroundColor: OPP_COLOR, padding: 12 }}>
              <Text style={{ marginTop: 16, color: BASE_COLOR }}>Please update the new version to continue using the app!</Text>
              <Text style={{ marginTop: 16, color: BASE_COLOR }}>Press to update!</Text>
              <TouchableOpacity style={{ marginTop: 16 }} onPress={updateNewVersion}>
                <Icon name='md-download-outline' size={48} color={BASE_COLOR} />
              </TouchableOpacity>
            </View>
      }
    </SafeAreaView>
