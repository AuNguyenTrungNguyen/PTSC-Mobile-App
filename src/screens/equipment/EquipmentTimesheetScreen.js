...
import { GetEquipmentBookingDetailAPI, GetEquipmentWastageReasonListAPI, UpdateEquipmentBookingDetailAPI } from '../../apis/equipment/EquipmentAPI';
...
const EquipmentTimesheetScreen = ({ route, navigation }) => {

  const { id, code, category, project, department } = route.params;
  ...
  const getData = async () => {
    await Promise.all(
      [
        GetEquipmentBookingDetailAPI(id),
  ...
  //-- Render
  const RenderDetail = () => {
    const isStartDate_Actual = columnChange.includes('StartDate_Actual');
    const isEndDate_Actual = columnChange.includes('EndDate_Actual');
              ...
              <View style={styles.row}>
                ...
                <View style={styles.cellData}>
                  <View style={styles.containerAction}>
                    <Text style={styles.textBlue}>{Formater.formatDateDataTime(bookingDetail.StartDate)}</Text>
                  </View>
                </View>
              </View>
              <View style={styles.row}>
                ...
                <View style={styles.cellData}>
                  <View style={styles.containerAction}>
                    <Text style={styles.textBlue}>{Formater.formatDateDataTime(bookingDetail.EndDate)}</Text>
                  </View>
                </View>
              </View>
              <View style={styles.row}>
...
export default EquipmentTimesheetScreen;