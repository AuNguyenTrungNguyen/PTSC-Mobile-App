...
import { GetWorkRequestHeaderListAPI } from '../../apis/equipment/EquipmentAPI';

import { ListSelectData, ListLoadingData, ListEmptyData } from '../../components/HelperUI';
import LoadingRefresh from '../../components/LoadingRefresh';

const WorkRequestListScreen = ({ _, navigation }) => {
  ...
  const [workRequestList, setWorkRequestList] = useState(null);
  ...
  async function getEquipmentList() {
    GetWorkRequestHeaderListAPI(documentNo, '')
      .then(res => {
        if (res.Success && res.Data) {
          setWorkRequestList(res.Data);
          setIsLoading(false);
          setIsError(false);
    ...
    <SafeAreaView style={styles.safeArea}>
      {
        isLoading || isError
          ...
          <View style={styles.container}>
            ...
            {
              workRequestList && workRequestList.length
                ?
                <VirtualizedList
                  style={styles.table}
...
export default WorkRequestListScreen;