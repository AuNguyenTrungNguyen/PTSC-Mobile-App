...
import { GetEquipmentNameListAPI } from '../../apis/equipment/EquipmentAPI';

import { ListSelectData, ListLoadingData, ListEmptyData } from '../../components/HelperUI';
import LoadingRefresh from '../../components/LoadingRefresh';

const EquipmentNameListScreen = ({ _, navigation }) => {
  ...
  async function getEquipmentList() {
    GetEquipmentNameListAPI(equipmentname)
      .then(res => {
  ...
  const RenderList = () => {
    {
      if (isSearching) {
        ...
        return <ListSelectData title={'Please enter Equipment Name'} />
      } else {
...
export default EquipmentNameListScreen;