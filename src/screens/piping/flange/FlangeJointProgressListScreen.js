...
const FlangeJointProgressListScreen = ({ route, navigation }) => {
  ...
  const [flangeJointList, setFlangeJointList] = useState(null);
  ...
  //-- Search Action
  const _onPressSearchFlangeJoint = () => {
    Keyboard.dismiss();
                ...
                (<View style={styles.headerContainer}>
                  ...
                  <View style={styles.rowInfoAction}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={_onPressSearchFlangeJoint}
...
export default FlangeJointProgressListScreen;