...
import { GetPipeSupportListAPI } from '../../../apis/piping/ConstructionAPI';

import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';
import SelectPopup from '../../../components/SelectPopup';

const PipeSupportListScreen = ({ route, navigation }) => {
  ...
  //-- Search Action
  const _onPressSearchSupport = () => {
    Keyboard.dismiss();
    callAPI(getSupportData);
  };
  ...
  const RenderList = () => {
    {
      if (isSearching) {
        ...
        return <ListSelectData title={'Please select Facility / PipeName'} />
      } else {
    ...
    <SafeAreaView style={styles.safeArea}>
      {
        isLoading || isError
          ?
          <LoadingRefresh isLoading={isLoading} isError={isError} _onPressRefresh={() => callAPI(getSupportData)} />
          :
          <View style={styles.container}>
            {
              isShowDescription.show
                ...
                (<View style={styles.headerContainer}>
                  ...
                  <View style={styles.rowInfoAction}>
                    <Text style={styles.infoTitleAction}>PipeName:</Text>
                    <View style={styles.inputContainer}>
                      <TextInput
                        style={styles.inputText}
                        value={supportName}
                        onChangeText={_onChangeSupportName}
                        underlineColorAndroid='transparent'
                      />
                      {
                        supportName == ''
                          ? null
                          : <Icon name='times-circle' onPress={() => _onChangeSupportName('')} style={styles.inputIcon} />
                      }
                    </View>
                  </View>
                  <View style={styles.rowInfoAction}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={_onPressSearchSupport}
                      disabled={isSearching}>
                      <Text style={styles.buttonTitle}>Search Pipe</Text>
                    </TouchableOpacity>
                  </View>
                </View>)
                :
            ...
            {
              supportList && supportList.length
                ?
                <>
...
export default PipeSupportListScreen;