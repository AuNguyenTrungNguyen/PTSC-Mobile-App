...
import { GetTestPackageListAPI } from '../../../apis/piping/ConstructionAPI';

import { ListSelectData, ListLoadingData, ListEmptyData } from '../../../components/HelperUI';
import LoadingRefresh from '../../../components/LoadingRefresh';
import SelectPopup from '../../../components/SelectPopup';

const HydrotestPackageListScreen = ({ route, navigation }) => {
  ...
  async function getSpoolData({ facility = facilityCode } = {}) {
    ...
    GetTestPackageListAPI(projectCode, facility, spoolNo)
      .then(res => {
  ...
  const _onPressDetail = async (item) => {
    navigation.navigate(
      'HydrotestPackageDetail',
      {
        projectCode: projectCode,
        facilityCode: item.FacilityCode,
        testPackNo: item.TestPackNo,
      }
    );
  };
    ...
    return (
      <TouchableOpacity style={styles.box} onPress={() => _onPressDetail(item)}>
        ...
        <View style={styles.row}>
          <View style={styles.cellThree}>
            <Text>TestNo:   </Text>
            <Text style={styles.textData}>{Formater.formatEmptyData(item.TestPackNo)}</Text>
          </View>
        </View>
      </TouchableOpacity>
    );
  ...
  const RenderList = () => {
    {
      if (isSearching) {
        ...
        return <ListSelectData title={'Please select Facility / TestNo'} />
      } else {
          ...
          <View style={styles.container}>
            {
              isShowDescription.show
                ...
                (<View style={styles.headerContainer}>
                  ...
                  <View style={styles.rowInfoAction}>
                    <Text style={styles.infoTitleAction}>TestNo:</Text>
                  ...
                  <View style={styles.rowInfoAction}>
                    ...
                    <TouchableOpacity
                      ...
                      <Text style={styles.buttonTitle}>Search Test Package</Text>
                    </TouchableOpacity>
                  </View>
                </View>)
                :
...
export default HydrotestPackageListScreen;